...
function Navbar() {
  ...
  return (
    <nav className="sm:p-4 overflow-hidden fixed w-full pb-4 z-50 top-0 left-0 bg-bground pt-4">
      ...
      {isOpen && (
        <div className="md:hidden py-4 flex cursor-pointer justify-center items-center">
          <div className=" justify-between items-center">
            <NavLink
              to="/"
              className="block text-center text-[#00FFD1] my-3 capitalize relative cursor-pointer transition-all  duration-500 before:content-['']  before:absolute before:-bottom-2 before:left-0 before:w-0 before:h-0.5  before:rounded-full  before:opacity-0  before:transition-all  before:duration-500 before:bg-[#00FFD1] hover:before:w-full hover:before:opacity-100"
              onClick={() => setIsOpen(!isOpen)}
            >
              Home
            </NavLink>
